...
public class Painting extends Art {
    ...
    // Additional attributes specific to Painting (Immutable after construction)
    ...
    /**
     * Constructs a Painting object by invoking the Art superclass constructor
     * and validating painting-specific fields.
     *
    ...
    public Painting(String artIdentification, double price, int yearCreated, String title,
        ...
        if (height <= 0 || width <= 0) {
            throw new InvalidArtOperationException("Painting Creation",
                    "Height and width must be positive integers.");
        } // End if statement

        // Validate enums are not null
        if (style == null || technique == null || category == null) {
            throw new InvalidArtOperationException("Painting Creation", "Style, Technique, " +
    ...
    public static Painting fromString(String data) {
        ...
        return new Painting(
                ...
                parts[5],                                // Description
                parts[3],                                // Author
                ItemStatus.valueOf(parts[12]),           // Item Status
